...
public class FeetsIntoMettersConverter {

    private int myFeet;
    private int myInch;

    public FeetsIntoMettersConverter(int myFeet, int myInch) {
        this.myFeet = myFeet;
        this.myInch = myInch;
    }
...
//  double FeetInchToCm = (feets*ratio)+((inches/12)*ratio);

       // String FeetInchToCm2f = String.format("%.2f", FeetInchToCm);
//        double DimmInFeet = meters * mIsFeet;
//        int inInchRound = ((int) Math.ceil((DimmInFeet % 1) * 12));
//        int inFeetRound = (int) (Math.floor(DimmInFeet));feet/FeetsIntoMettersConverter.java:11
//        System.out.println(FeetInchToCm);
//        System.out.println(FeetInchToCm2f);
       // System.out.println(16.3*ratio);
...
//package feet;
//
//class MettersIntoFeetConverter {
//
//    double meters;
//    double ratioMtoF = 3.2808399;
//
